...
<!-- 	<div class="col-lg-6  padding">
		...
		<div class="container col-lg-6">
			<div class="list-group">
				<a href="patients.php" class="list-group-item active" style="background-color: rgb(32,57,53)"> <h1><i class="fa fa-wheelchair" aria-hidden="true"></i> Patients</h1></a>
				<a href="patient-details.php" class="list-group-item"><strong>Patients Details</strong> </a>
				<a href="add-patients.php" class="list-group-item"><strong>Add new Patients</strong> </a>
				<a href="" class="list-group-item"><strong>Discharge Patients</strong> </a>
			</div>
		</div>		
