...
<div class="container-fluid">
	<div class="col-lg-12 padding ">
		<div class="card">
			...
			<a href="" class="list-group-item active" style="background-color: rgb(32,57,53)"> <h3 class="alignmiddle container"><i class="fa fa-address-card" aria-hidden="true"></i>  Add Patients</h3></a>
			<div class="card-body">
				...
				<form class="form-group" action="func.php" method="post">
					...
					<input type="submit" class="btn btn-primary" name="pat_submit" value="Enter Values">
