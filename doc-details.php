...
$patients_list=mysqli_query($con,"select * from add_doc");
mysqli_close($con);
?>
...
<div class="col-lg-12 col-md-6 padding padding-bottom">
		<div class="list-group">
			<center><a href="doc-details.php" class="list-group-item active" style="background-color: rgb(32,57,53)"> <h1><i class="fa fa-user-md" aria-hidden="true"></i>
 Doctor Details</h1></a></center>
			
		</div>
		 
	

<p><center> <h3>Welcome to the Doctor list </h3></center></p>
<div>
	<center>
<table>
	<!-- <thead>
	...
	<tr>
		...
		<td><?php echo $patients_list['doc_name']; ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
