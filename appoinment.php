...
<div class="jumbotron " style="background: url(images/30.jpg); background-size: cover; height: 450px;background-position: center center">
...
<!-- 	<div class="col-lg-6  padding">
		...
		<div class="container col-lg-6">
			<div class="list-group">
				...
				<a href="create-appointment.php" class="list-group-item"><strong>Add Appointment</strong> </a>
				<a href="view-appointment.php" class="list-group-item"><strong>View Appointments</strong> </a>
			</div>
		</div>		
